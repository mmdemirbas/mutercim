...
var schemaAnnotations = map[string]schemaMeta{
	...
	"read.models[]":                       {},
	"read.models[].provider":              {Description: "AI provider name. Determines the API endpoint and authentication method.", Enum: []string{"gemini", "claude", "openai", "groq", "mistral", "openrouter", "xai", "ollama", "llamacpp", "mlx"}},
	...
	"translate.models[]":                       {},
	"translate.models[].provider":              {Description: "AI provider name.", Enum: []string{"gemini", "claude", "openai", "groq", "mistral", "openrouter", "xai", "ollama", "llamacpp", "mlx"}},
