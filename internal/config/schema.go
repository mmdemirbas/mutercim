...
var schemaAnnotations = map[string]schemaMeta{
	...
	"ocr.quantize": {Description: "Model quantization for OCR. '8bit' is recommended by authors for OCR accuracy. 'none' uses full precision (more VRAM, marginally better).", Default: "8bit", Enum: []string{"8bit", "none"}},
